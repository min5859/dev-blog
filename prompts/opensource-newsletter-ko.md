...
- 각 항목 필드:
  ...
  - `affectedAudience` — 도입을 검토할 개발자 그룹. 예: `"TypeScript 도입 검토자"`.
  - `verifyLink` — repo URL.
...
```json
{
  ...
  "highlights": [
    { "title": "owner/repo", "priority": "상", "impactType": "project", "affectedAudience": "TypeScript 도입 검토자", "verifyLink": "https://github.com/...", "action": "..." }
  ],
  "sections": [
...
"highlights": [
  {
    ...
    "priority": "상",
    "impactType": "project",
    "affectedAudience": "TypeScript 도입 검토자",
