...
if (!topic) {
  console.error('Usage: node scripts/publish-lore-lens.mjs <topicId>');
  process.exit(1);
}
...
function validatePost(post, expectedTopic) {
  ...
  if (post.topic !== expectedTopic) throw new Error(`publish candidate topic must be ${expectedTopic}`);
